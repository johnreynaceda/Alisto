                        ...
                        <div class="flex flex-shrink-0 p-4 px-4 bg-gray-50">
                            <div @click.away="open = false" class="relative inline-flex items-center w-full"
                                ...
                                <button @click="open = !open"
                                    class="inline-flex items-center justify-between w-full  py-3 text-lg font-medium text-center text-white transition duration-500 ease-in-out transform rounded-xl hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                    <span>
                                        <span class="flex-shrink-0 block group">
                                            <div class="flex items-center">
                                                <div>
                                                    {{-- <img class="inline-block object-cover rounded-full h-20 w-20"
                                                        src="{{ asset('images/alisto-logo.png') }}" alt=""> --}}
                                                    @if (auth()->user()->user_profile != null)
                                                        <img class=" flex-shrink-0 object-cover rounded-full h-20 w-20"
