    ...
    <x-modal wire:model.defer="view_modal" align="center" max-width="3xl">
        <x-card title="View Details">
            <div class="grid grid-cols-2 gap-5">
                ...
                <div>
                    <h1 class="text-sm uppercase">Client Number</h1>
                    <h1 class="text-lg font-bold">
                        {{ $view_details->user->client_information->contact_number ?? '' }}
                    </h1>
                </div>
                <div>
            ...
            <div class="mt-5 grid grid-cols-2 gap-5">
                ...
                <div class="col-span-2">
                    <h1 class="text-sm uppercase">Valid id</h1>
                    <div class="mt-2">
                        <img src="{{ Storage::url($view_details->user->client_information->identification_card_path ?? '') }}"
                            alt="" class="border h-96 w-full object-cover rounded-xl">
                    </div>
                </div>
            </div>
            <x-slot name="footer">
