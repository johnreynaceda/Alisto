    ...
    <div>
        <div class="grid grid-cols-4 gap-5">
            <div class="border-2 cursor-pointer border-main bg-gray-100 rounded-xl relative overflow-hidden group p-6">
                ...
                <div>
                    <p class="font-bold text-main text-3xl">{{ $service_provider }}</p>
                    <p class="mt-1 text-gray-500">Total Service Provider</p>
                </div>
            ...
            <div class="border-2 cursor-pointer border-main bg-gray-100 rounded-xl relative overflow-hidden group p-6">
                ...
                <div>
                    <p class="font-bold text-main text-3xl">{{ $services }}</p>
            ...
            <div class="border-2 cursor-pointer border-main bg-gray-100 rounded-xl relative overflow-hidden group p-6">
                ...
                <div>
                    <p class="font-bold text-main text-3xl">{{ $clients }}</p>
            ...
            <div class="border-2 cursor-pointer border-main bg-gray-100 rounded-xl relative overflow-hidden group p-6">
                ...
                <div>
                    <p class="font-bold text-main text-3xl">{{ $categories }}</p>
                    <p class="mt-1 text-gray-500">Total Category </p>
                </div>
                <div class="absolute -bottom-2 -right-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        class="h-20 opacity-20 group-hover:opacity-50 fill-main">
